				...
				<div class="navbar-header">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						...
						<ul class="nav navbar-nav navbar-right">
							<li><a href="profil1.php"><?php echo $_SESSION['nama_lengkap'] ?></a></li>
							<li class="dropdown">
		...
		<div id="container" class="container">
			...
			<div>
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane active" id="rankking">
						<br/>
							<h4>Nilai Alternatif Kriteria</h4>
								<table width="100%" class="table table-stripsed table-bordered">
									<thead>
										<tr>
										...
										<tr>
											...
											?>
												<th><?php echo $row2x['nama_kriteria'] ?><br/>
													(<?php echo $row2x['tipe_kriteria'] ?>)
												</th>
												<?php
													}
												?>
